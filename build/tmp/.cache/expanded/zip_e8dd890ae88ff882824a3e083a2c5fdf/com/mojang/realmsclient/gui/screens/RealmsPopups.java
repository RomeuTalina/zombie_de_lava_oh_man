...
public class RealmsPopups {
    ...
    public static PopupScreen customPopupScreen(Screen pBackgroundScreen, Component pTitle, Component pMessage, Consumer<PopupScreen> pOnContinue) {
        return new PopupScreen.Builder(pBackgroundScreen, pTitle)
            .setMessage(pMessage)
