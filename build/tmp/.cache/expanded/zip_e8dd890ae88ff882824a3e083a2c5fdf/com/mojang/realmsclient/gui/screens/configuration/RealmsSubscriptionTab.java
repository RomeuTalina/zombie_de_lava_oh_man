...
class RealmsSubscriptionTab extends GridLayoutTab implements RealmsConfigurationTab {
    ...
    RealmsSubscriptionTab(RealmsConfigureWorldScreen pConfigurationScreen, Minecraft pMinecraft, RealmsServer pServerData) {
        ...
        Font font = pConfigurationScreen.getFont();
        ...
        gridlayout$rowhelper.addChild(
            Button.builder(
                    ...
                    p_410602_ -> ConfirmLinkScreen.confirmLinkNow(pConfigurationScreen, CommonLinks.extendRealms(pServerData.remoteSubscriptionId, pMinecraft.getUser().getProfileId()))
                )
                .bounds(0, 0, 200, 20)
                .build()
        );
        ...
        this.deleteButton = gridlayout$rowhelper.addChild(
            Button.builder(
                    ...
                    p_406845_ -> pMinecraft.setScreen(
                        RealmsPopups.warningPopupScreen(pConfigurationScreen, Component.translatable("mco.configure.world.delete.question.line1"), p_409393_ -> this.deleteRealm())
                    )
                )
                .bounds(0, 0, 200, 20)
                .build()
