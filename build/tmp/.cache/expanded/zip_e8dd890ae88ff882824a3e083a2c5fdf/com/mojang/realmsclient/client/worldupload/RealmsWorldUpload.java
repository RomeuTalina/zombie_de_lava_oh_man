...
public class RealmsWorldUpload {
    ...
    public RealmsWorldUpload(Path pWorldFolder, RealmsSlot pRealmsSlot, User pUser, long pRealmId, RealmsWorldUploadStatusTracker pStatusCallback) {
        this.worldFolder = pWorldFolder;
        this.realmsSlot = pRealmsSlot;
        this.user = pUser;
