...
public class RealmsServerList extends ValueObject implements ReflectionBasedSerialization {
    ...
    public static RealmsServerList parse(GuardedSerializer pSerializer, String pJson) {
        try {
            RealmsServerList realmsserverlist = pSerializer.fromJson(pJson, RealmsServerList.class);
            if (realmsserverlist == null) {
                LOGGER.error("Could not parse McoServerList: {}", pJson);
