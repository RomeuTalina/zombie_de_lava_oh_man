...
public interface VertexConsumer extends net.minecraftforge.client.extensions.IForgeVertexConsumer {
    ...
    default VertexConsumer addVertexWith2DPose(Matrix3x2f pPose, float pX, float pY, float pZ) {
        Vector2f vector2f = pPose.transformPosition(pX, pY, new Vector2f());
        return this.addVertex(vector2f.x(), vector2f.y(), pZ);
    }
