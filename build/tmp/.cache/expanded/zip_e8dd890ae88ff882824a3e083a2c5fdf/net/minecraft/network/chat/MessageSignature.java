...
public record MessageSignature(byte[] bytes) {
    ...
    public boolean equals(Object pOther) {
        return this == pOther || pOther instanceof MessageSignature messagesignature && Arrays.equals(this.bytes, messagesignature.bytes);
    }
    ...
    public static String describe(@Nullable MessageSignature pSignature) {
        return pSignature == null ? "<no signature>" : pSignature.toString();
    }
