...
public class FriendlyByteBuf extends ByteBuf {
    ...
    public <T> T readLenientJsonWithCodec(Codec<T> pCodec) {
    ...
    public <L, R> void writeEither(
        Either<L, R> pEither, StreamEncoder<? super FriendlyByteBuf, L> pLeftWriter, StreamEncoder<? super FriendlyByteBuf, R> pRightWriter
    ) {
        pEither.ifLeft(p_405098_ -> {
            this.writeBoolean(true);
            pLeftWriter.encode(this, (L)p_405098_);
        }).ifRight(p_405100_ -> {
            this.writeBoolean(false);
            pRightWriter.encode(this, (R)p_405100_);
        });
    }

    public <L, R> Either<L, R> readEither(StreamDecoder<? super FriendlyByteBuf, L> pLeftReader, StreamDecoder<? super FriendlyByteBuf, R> pRightReader) {
        return this.readBoolean() ? Either.left(pLeftReader.decode(this)) : Either.right(pRightReader.decode(this));
    }
    ...
    public <T> T readById(IntFunction<T> pIdLookup) {
        int i = this.readVarInt();
