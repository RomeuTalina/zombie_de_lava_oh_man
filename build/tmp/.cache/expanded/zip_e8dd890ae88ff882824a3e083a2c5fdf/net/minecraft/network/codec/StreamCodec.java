    ...
    static <B, C, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> StreamCodec<B, C> composite(
        ...
        return new StreamCodec<B, C>() {
            ...
            public C decode(B p_397382_) {
                T1 t1 = pCodec1.decode(p_397382_);
                T2 t2 = pCodec2.decode(p_397382_);
                T3 t3 = pCodec3.decode(p_397382_);
                T4 t4 = pCodec4.decode(p_397382_);
                T5 t5 = pCodec5.decode(p_397382_);
                T6 t6 = pCodec6.decode(p_397382_);
                T7 t7 = pCodec7.decode(p_397382_);
                T8 t8 = pCodec8.decode(p_397382_);
                T9 t9 = pCodec9.decode(p_397382_);
                T10 t10 = pCodec10.decode(p_397382_);
                T11 t11 = pCodec11.decode(p_397382_);
                return pFactory.apply(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11);
            }

            @Override
            public void encode(B p_396343_, C p_395545_) {
                pCodec1.encode(p_396343_, pGetter1.apply(p_395545_));
                pCodec2.encode(p_396343_, pGetter2.apply(p_395545_));
                pCodec3.encode(p_396343_, pGetter3.apply(p_395545_));
                pCodec4.encode(p_396343_, pGetter4.apply(p_395545_));
                pCodec5.encode(p_396343_, pGetter5.apply(p_395545_));
                pCodec6.encode(p_396343_, pGetter6.apply(p_395545_));
                pCodec7.encode(p_396343_, pGetter7.apply(p_395545_));
                pCodec8.encode(p_396343_, pGetter8.apply(p_395545_));
                pCodec9.encode(p_396343_, pGetter9.apply(p_395545_));
                pCodec10.encode(p_396343_, pGetter10.apply(p_395545_));
                pCodec11.encode(p_396343_, pGetter11.apply(p_395545_));
            }
        };
    }
