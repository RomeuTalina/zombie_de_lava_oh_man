...
public class ComponentUtils {
    ...
    private static Style resolveStyle(@Nullable CommandSourceStack pCommandSourceStack, Style pStyle, @Nullable Entity pEntity, int pRecursionDepth) throws CommandSyntaxException {
        if (pStyle.getHoverEvent() instanceof HoverEvent.ShowText(Component $$6)) {
            HoverEvent hoverevent = new HoverEvent.ShowText(updateForEntity(pCommandSourceStack, $$6, pEntity, pRecursionDepth + 1));
            return pStyle.withHoverEvent(hoverevent);
        } else {
            return pStyle;
        }
    }
    ...
    public static Component fromMessage(Message pMessage) {
        return (Component)(pMessage instanceof Component component ? component : Component.literal(pMessage.getString()));
    }
            ...
            Component.literal(pText)
                .withStyle(
                    p_389914_ -> p_389914_.withColor(ChatFormatting.GREEN)
                        .withClickEvent(new ClickEvent.CopyToClipboard(pText))
