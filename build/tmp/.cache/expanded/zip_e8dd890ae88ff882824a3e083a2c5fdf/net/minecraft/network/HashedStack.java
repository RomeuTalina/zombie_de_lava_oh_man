...
public interface HashedStack {
    ...
    boolean matches(ItemStack pStack, HashedPatchMap.HashGenerator pHashGenerator);

    static HashedStack create(ItemStack pStack, HashedPatchMap.HashGenerator pHashGenerator) {
        return (HashedStack)(pStack.isEmpty()
            ? EMPTY
            : new HashedStack.ActualItem(pStack.getItemHolder(), pStack.getCount(), HashedPatchMap.create(pStack.getComponentsPatch(), pHashGenerator)));
    }
