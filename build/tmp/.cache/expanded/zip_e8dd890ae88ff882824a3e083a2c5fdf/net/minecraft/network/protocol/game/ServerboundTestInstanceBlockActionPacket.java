...
public record ServerboundTestInstanceBlockActionPacket(
    ...
    public ServerboundTestInstanceBlockActionPacket(
        BlockPos pPos,
        ServerboundTestInstanceBlockActionPacket.Action pAction,
        Optional<ResourceKey<GameTestInstance>> pTest,
        Vec3i pSize,
        Rotation pRotation,
        ...
        this(
            pPos,
            pAction,
            new TestInstanceBlockEntity.Data(pTest, pSize, pRotation, pIgnoreEntities, TestInstanceBlockEntity.Status.CLEARED, Optional.empty())
        );
    }
