...
public record PlayerChatMessage(
    ...
    public static String describeSigned(PlayerChatMessage pChatMessage) {
        return "'"
            + pChatMessage.signedBody.content()
            + "' @ "
            + pChatMessage.signedBody.timeStamp()
            + "\n - From: "
            + pChatMessage.link.sender()
            + "/"
            + pChatMessage.link.sessionId()
            + ", message #"
            + pChatMessage.link.index()
            + "\n - Salt: "
            + pChatMessage.signedBody.salt()
            + "\n - Signature: "
            + MessageSignature.describe(pChatMessage.signature)
            + "\n - Last Seen: [\n"
            + pChatMessage.signedBody
                .lastSeen()
                .entries()
                .stream()
