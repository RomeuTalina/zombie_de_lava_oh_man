...
public class ClientboundSetPlayerTeamPacket implements Packet<ClientGamePacketListener> {
    ...
    public static class Parameters {
        ...
        public Parameters(PlayerTeam pTeam) {
            ...
            this.nametagVisibility = pTeam.getNameTagVisibility();
            this.collisionRule = pTeam.getCollisionRule();
        ...
        public Parameters(RegistryFriendlyByteBuf pBuffer) {
            ...
            this.nametagVisibility = Team.Visibility.STREAM_CODEC.decode(pBuffer);
            this.collisionRule = Team.CollisionRule.STREAM_CODEC.decode(pBuffer);
        ...
        public void write(RegistryFriendlyByteBuf pBuffer) {
            ...
            Team.Visibility.STREAM_CODEC.encode(pBuffer, this.nametagVisibility);
            Team.CollisionRule.STREAM_CODEC.encode(pBuffer, this.collisionRule);
