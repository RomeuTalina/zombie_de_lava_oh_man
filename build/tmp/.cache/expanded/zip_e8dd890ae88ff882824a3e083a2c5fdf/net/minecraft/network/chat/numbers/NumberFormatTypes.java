...
public class NumberFormatTypes {
    ...
    public static NumberFormatType<?> bootstrap(Registry<NumberFormatType<?>> pRegistry) {
        Registry.register(pRegistry, "blank", BlankFormat.TYPE);
        Registry.register(pRegistry, "styled", StyledFormat.TYPE);
        return Registry.register(pRegistry, "fixed", FixedFormat.TYPE);
    }
}