...
public class DataComponentPredicates {
    ...
    private static <T extends DataComponentPredicate> DataComponentPredicate.Type<T> register(String pName, Codec<T> pCodec) {
        return Registry.register(BuiltInRegistries.DATA_COMPONENT_PREDICATE_TYPE, pName, new DataComponentPredicate.Type<>(pCodec));
    }
