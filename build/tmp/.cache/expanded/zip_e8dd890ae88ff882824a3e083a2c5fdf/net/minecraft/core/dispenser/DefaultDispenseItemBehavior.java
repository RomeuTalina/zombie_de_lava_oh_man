...
public class DefaultDispenseItemBehavior implements DispenseItemBehavior {
    ...
    public static void spawnItem(Level pLevel, ItemStack pStack, int pSpeed, Direction pFacing, Position pPosition) {
        ...
        itementity.setDeltaMovement(
            pLevel.random.triangle(pFacing.getStepX() * d3, 0.0172275 * pSpeed),
            pLevel.random.triangle(0.2, 0.0172275 * pSpeed),
            pLevel.random.triangle(pFacing.getStepZ() * d3, 0.0172275 * pSpeed)
        );
