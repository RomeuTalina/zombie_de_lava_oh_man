...
public enum Direction implements StringRepresentable {
    ...
    private Direction(
        ...
        this.normalVec3f = new Vector3f(pNormal.getX(), pNormal.getY(), pNormal.getZ());
    }
    ...
    public static Direction rotate(Matrix4fc pMatrix, Direction pDirection) {
        Vector3f vector3f = pMatrix.transformDirection(pDirection.normalVec3f, new Vector3f());
    ...
    public static Direction getApproximateNearest(float pX, float pY, float pZ) {
        ...
        for (Direction direction1 : VALUES) {
            float f1 = pX * direction1.normal.getX()
                + pY * direction1.normal.getY()
                + pZ * direction1.normal.getZ();
            if (f1 > f) {
                f = f1;
    ...
    public static enum Axis implements StringRepresentable, Predicate<Direction> {
        ...
        public abstract boolean choose(boolean pX, boolean pY, boolean pZ);
    }
