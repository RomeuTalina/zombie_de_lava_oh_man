...
public abstract class RecipeProvider {
    ...
    protected void colorItemWithDye(List<Item> pDyeItems, List<Item> pDyeableItems, String pGroup, RecipeCategory pCategory) {
        this.colorWithDye(pDyeItems, pDyeableItems, null, pGroup, pCategory);
    }
    ...
    protected void dryGhast(ItemLike pDryGhast) {
        this.shaped(RecipeCategory.BUILDING_BLOCKS, pDryGhast, 1)
    ...
    protected void harness(ItemLike pHarness, ItemLike pWool) {
        this.shaped(RecipeCategory.COMBAT, pHarness)
            .define('#', pWool)
