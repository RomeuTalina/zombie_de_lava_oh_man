...
public class TerrainProvider {
    ...
    public static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> buildErosionOffsetSpline(
        I pErosion,
        I pRidgesFolded,
        float pRidgeBaseOffset,
        float pRidgeMidOffset,
        float pRidgePeakOffset,
        float pMagnitude,
        float pRidgeInnerOffset,
        float pRidgeOuterOffset,
        boolean pExtended,
        ...
        CubicSpline<C, I> cubicspline3 = ridgeSpline(
            pRidgesFolded, pRidgeBaseOffset - 0.15F, 0.5F * pMagnitude, Mth.lerp(0.5F, 0.5F, 0.5F) * pMagnitude, 0.5F * pMagnitude, 0.6F * pMagnitude, 0.5F, pTransform
        );
        CubicSpline<C, I> cubicspline4 = ridgeSpline(
            pRidgesFolded, pRidgeBaseOffset, pRidgeInnerOffset * pMagnitude, pRidgeMidOffset * pMagnitude, 0.5F * pMagnitude, 0.6F * pMagnitude, 0.5F, pTransform
        );
        CubicSpline<C, I> cubicspline5 = ridgeSpline(pRidgesFolded, pRidgeBaseOffset, pRidgeInnerOffset, pRidgeInnerOffset, pRidgeMidOffset, pRidgePeakOffset, 0.5F, pTransform);
        CubicSpline<C, I> cubicspline6 = ridgeSpline(pRidgesFolded, pRidgeBaseOffset, pRidgeInnerOffset, pRidgeInnerOffset, pRidgeMidOffset, pRidgePeakOffset, 0.5F, pTransform);
        CubicSpline<C, I> cubicspline7 = CubicSpline.<C, I>builder(pRidgesFolded, pTransform)
            .addPoint(-1.0F, pRidgeBaseOffset)
            .addPoint(-0.4F, cubicspline5)
            .addPoint(0.0F, pRidgePeakOffset + 0.07F)
            .build();
        CubicSpline<C, I> cubicspline8 = ridgeSpline(pRidgesFolded, -0.02F, pRidgeOuterOffset, pRidgeOuterOffset, pRidgeMidOffset, pRidgePeakOffset, 0.0F, pTransform);
        CubicSpline.Builder<C, I> builder = CubicSpline.<C, I>builder(pErosion, pTransform)
