...
public class VanillaItemTagsProvider extends IntrinsicHolderTagsProvider<Item> {
    public VanillaItemTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pLookupProvider) {
        super(pOutput, Registries.ITEM, pLookupProvider, p_405065_ -> p_405065_.builtInRegistryHolder().key());
    }

    public VanillaItemTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pLookupProvider, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
        super(pOutput, Registries.ITEM, pLookupProvider, p_405065_ -> p_405065_.builtInRegistryHolder().key(), modId, existingFileHelper);
    }
    ...
    public static class BlockToItemConverter implements TagAppender<Block, Block> {
        ...
        public BlockToItemConverter(TagAppender<Item, Item> pItemAppender) {
            this.itemAppender = pItemAppender;
        }
        ...
        private static TagKey<Item> blockTagToItemTag(TagKey<Block> pTag) {
            return TagKey.create(Registries.ITEM, pTag.location());
        }
