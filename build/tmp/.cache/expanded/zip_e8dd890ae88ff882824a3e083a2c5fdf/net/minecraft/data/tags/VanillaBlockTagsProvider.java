...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    ...
    public VanillaBlockTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pLookupProvider, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
        super(pOutput, Registries.BLOCK, pLookupProvider, p_255627_ -> p_255627_.builtInRegistryHolder().key(), modId, existingFileHelper);
    }
