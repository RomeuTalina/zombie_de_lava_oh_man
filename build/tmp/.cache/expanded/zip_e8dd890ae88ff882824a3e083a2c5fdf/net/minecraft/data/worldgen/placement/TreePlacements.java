...
public class TreePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> pContext) {
        ...
        PlacementUtils.register(pContext, OAK_BEES_0002_LEAF_LITTER, holder21, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        ...
        PlacementUtils.register(pContext, BIRCH_BEES_0002_LEAF_LITTER, holder24, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(pContext, BIRCH_BEES_002, holder25, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(pContext, FANCY_OAK_BEES_0002_LEAF_LITTER, holder26, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(pContext, FANCY_OAK_BEES_002, holder27, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(pContext, FANCY_OAK_BEES, holder28, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(pContext, CHERRY_BEES_005, holder29, PlacementUtils.filteredByBlockSurvival(Blocks.CHERRY_SAPLING));
        PlacementUtils.register(pContext, OAK_LEAF_LITTER, holder30, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(pContext, DARK_OAK_LEAF_LITTER, holder31, PlacementUtils.filteredByBlockSurvival(Blocks.DARK_OAK_SAPLING));
        PlacementUtils.register(pContext, BIRCH_LEAF_LITTER, holder32, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(pContext, FANCY_OAK_LEAF_LITTER, holder33, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(pContext, FALLEN_OAK_TREE, holder34, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(pContext, FALLEN_BIRCH_TREE, holder35, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(pContext, FALLEN_SUPER_BIRCH_TREE, holder36, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        PlacementUtils.register(pContext, FALLEN_SPRUCE_TREE, holder37, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(pContext, FALLEN_JUNGLE_TREE, holder38, PlacementUtils.filteredByBlockSurvival(Blocks.JUNGLE_SAPLING));
    }
}