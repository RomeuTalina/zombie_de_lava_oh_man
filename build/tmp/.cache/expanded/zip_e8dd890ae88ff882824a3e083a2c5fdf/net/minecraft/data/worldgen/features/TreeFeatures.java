...
public class TreeFeatures {
    ...
    private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenBirch(int pMaxLength) {
        return createFallenTrees(Blocks.BIRCH_LOG, 5, pMaxLength);
    }
    ...
    private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenTrees(Block pLogBlock, int pMinLength, int pMaxLength) {
        return new FallenTreeConfiguration.FallenTreeConfigurationBuilder(BlockStateProvider.simple(pLogBlock), UniformInt.of(pMinLength, pMaxLength))
            .logDecorators(
                ImmutableList.of(
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> pContext) {
        ...
        FeatureUtils.register(pContext, DARK_OAK, Feature.TREE, createDarkOak().ignoreVines().build());
        FeatureUtils.register(
            pContext,
            PALE_OAK,
            Feature.TREE,
        ...
        FeatureUtils.register(
            pContext, OAK_BEES_0002_LEAF_LITTER, Feature.TREE, createOak().decorators(List.of(beehivedecorator, placeongrounddecorator, placeongrounddecorator1)).build()
        );
        ...
        FeatureUtils.register(
            pContext, BIRCH_BEES_0002_LEAF_LITTER, Feature.TREE, createBirch().decorators(List.of(beehivedecorator, placeongrounddecorator, placeongrounddecorator1)).build()
        );
        ...
        FeatureUtils.register(
            pContext, FANCY_OAK_BEES_0002_LEAF_LITTER, Feature.TREE, createFancyOak().decorators(List.of(beehivedecorator, placeongrounddecorator, placeongrounddecorator1)).build()
        );
        ...
        FeatureUtils.register(
            pContext, OAK_LEAF_LITTER, Feature.TREE, createOak().decorators(ImmutableList.of(placeongrounddecorator, placeongrounddecorator1)).build()
        );
        FeatureUtils.register(
            pContext,
        ...
        FeatureUtils.register(
            pContext, BIRCH_LEAF_LITTER, Feature.TREE, createBirch().decorators(ImmutableList.of(placeongrounddecorator, placeongrounddecorator1)).build()
        );
        FeatureUtils.register(
            pContext, FANCY_OAK_LEAF_LITTER, Feature.TREE, createFancyOak().decorators(List.of(placeongrounddecorator, placeongrounddecorator1)).build()
        );
        FeatureUtils.register(pContext, FALLEN_OAK_TREE, Feature.FALLEN_TREE, createFallenOak().build());
        FeatureUtils.register(pContext, FALLEN_BIRCH_TREE, Feature.FALLEN_TREE, createFallenBirch(8).build());
        FeatureUtils.register(pContext, FALLEN_SUPER_BIRCH_TREE, Feature.FALLEN_TREE, createFallenBirch(15).build());
        FeatureUtils.register(pContext, FALLEN_JUNGLE_TREE, Feature.FALLEN_TREE, createFallenJungle().build());
        FeatureUtils.register(pContext, FALLEN_SPRUCE_TREE, Feature.FALLEN_TREE, createFallenSpruce().build());
    }
}