        ...
        return BehaviorBuilder.create(
            p_259997_ -> p_259997_.group(
                ...
                .apply(p_259997_, (p_259831_, p_259115_, p_259521_, p_259223_) -> (p_405333_, p_405334_, p_405335_) -> {
                    ...
                    boolean flag = blockpos.closerThan(p_405334_.blockPosition(), pCloseEnoughDist);
                    if (!flag) {
                        BehaviorUtils.setWalkAndLookTargetMemories(p_405334_, getNearbyPos(p_405334_, blockpos), pSpeedModifier, pCloseEnoughDist);
                    }
