...
public abstract class VoxelShape {
    ...
    public VoxelShape move(Vec3i pOffset) {
        return this.move(pOffset.getX(), pOffset.getY(), pOffset.getZ());
    }
    ...
    public BlockHitResult clip(Vec3 pStartVec, Vec3 pEndVec, BlockPos pPos) {
        if (this.isEmpty()) {
            ...
            if (vec3.lengthSqr() < 1.0E-7) {
                ...
                return this.shape
                        .isFullWide(
                            this.findIndex(Direction.Axis.X, vec31.x - pPos.getX()),
                            this.findIndex(Direction.Axis.Y, vec31.y - pPos.getY()),
                            this.findIndex(Direction.Axis.Z, vec31.z - pPos.getZ())
                        )
