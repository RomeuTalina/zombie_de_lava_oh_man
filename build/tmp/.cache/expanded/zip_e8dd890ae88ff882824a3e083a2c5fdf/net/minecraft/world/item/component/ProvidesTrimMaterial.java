...
public record ProvidesTrimMaterial(EitherHolder<TrimMaterial> material) {
    ...
    public ProvidesTrimMaterial(Holder<TrimMaterial> pMaterial) {
        this(new EitherHolder<>(pMaterial));
    }

    @Deprecated
    public ProvidesTrimMaterial(ResourceKey<TrimMaterial> pMaterial) {
        this(new EitherHolder<>(pMaterial));
    }

    public Optional<Holder<TrimMaterial>> unwrap(HolderLookup.Provider pRegistries) {
        return this.material.unwrap(pRegistries);
    }
}