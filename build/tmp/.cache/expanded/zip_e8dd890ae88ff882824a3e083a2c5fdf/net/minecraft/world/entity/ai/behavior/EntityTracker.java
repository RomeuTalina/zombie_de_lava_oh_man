...
public class EntityTracker implements PositionTracker {
    ...
    public EntityTracker(Entity pEntity, boolean pTrackEyeHeight) {
        this(pEntity, pTrackEyeHeight, false);
    }

    public EntityTracker(Entity pEntity, boolean pTrackEyeHeight, boolean pTargetEyeHeight) {
        this.entity = pEntity;
        this.trackEyeHeight = pTrackEyeHeight;
        this.targetEyeHeight = pTargetEyeHeight;
    }
