...
public class Bogged extends AbstractSkeleton implements Shearable {
    ...
    private void spawnShearedMushrooms(ServerLevel pLevel, ItemStack pStack) {
        this.dropFromShearingLootTable(pLevel, BuiltInLootTables.BOGGED_SHEAR, pStack, (p_405498_, p_405499_) -> this.spawnAtLocation(p_405498_, p_405499_, this.getBbHeight()));
    }
