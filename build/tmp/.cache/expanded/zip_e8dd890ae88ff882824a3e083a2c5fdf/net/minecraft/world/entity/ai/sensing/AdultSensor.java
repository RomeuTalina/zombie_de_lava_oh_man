...
public class AdultSensor extends Sensor<LivingEntity> {
    ...
    protected void setNearestVisibleAdult(LivingEntity pEntity, NearestVisibleLivingEntities pNearestVisibleLivingEntities) {
        Optional<LivingEntity> optional = pNearestVisibleLivingEntities.findClosest(p_405417_ -> p_405417_.getType() == pEntity.getType() && !p_405417_.isBaby())
            .map(LivingEntity.class::cast);
        pEntity.getBrain().setMemory(MemoryModuleType.NEAREST_VISIBLE_ADULT, optional);
    }
}