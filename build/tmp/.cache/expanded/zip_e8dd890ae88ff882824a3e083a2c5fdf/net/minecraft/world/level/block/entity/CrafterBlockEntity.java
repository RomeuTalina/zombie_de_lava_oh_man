...
public class CrafterBlockEntity extends RandomizableContainerBlockEntity implements CraftingContainer {
    ...
    private void addDisabledSlots(ValueOutput pOutput) {
        ...
        pOutput.putIntArray("disabled_slots", intlist.toIntArray());
    }

    private void addTriggered(ValueOutput pOutput) {
        pOutput.putInt("triggered", this.containerData.get(9));
    }
