...
public class BuiltInLootTables {
    ...
    private static Map<DyeColor, ResourceKey<LootTable>> makeDyeKeyMap(String pPath) {
        return Util.makeEnumMap(DyeColor.class, p_391131_ -> register(pPath + "/" + p_391131_.getName()));
    }
