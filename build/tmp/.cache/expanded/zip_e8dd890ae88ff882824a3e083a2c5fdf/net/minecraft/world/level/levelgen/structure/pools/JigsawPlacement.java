                        ...
                        p_341930_ -> {
                            ...
                            if (pMaxDepth > 0) {
                                AABB aabb = new AABB(
                                    ...
                                    Math.max(i1 - pMaxDistanceFromCenter, levelheightaccessor.getMinY() + pDimensionPadding.bottom()),
                                    j - pMaxDistanceFromCenter,
                                    i + pMaxDistanceFromCenter + 1,
                                    Math.min(i1 + pMaxDistanceFromCenter + 1, levelheightaccessor.getMaxY() + 1 - pDimensionPadding.top()),
    ...
    static final class Placer {
        ...
        void tryPlacingChildren(
            ...
            for (StructureTemplate.JigsawBlockInfo structuretemplate$jigsawblockinfo : structurepoolelement.getShuffledJigsawBlocks(
                ...
                ResourceKey<StructureTemplatePool> resourcekey = pPoolAliasLookup.lookup(structuretemplate$jigsawblockinfo.pool());
                                            ...
                                            .mapToInt(
                                                p_360623_ -> {
                                                    ...
                                                    if (!boundingbox1.isInside(
                                                        ...
                                                        ResourceKey<StructureTemplatePool> resourcekey1 = pPoolAliasLookup.lookup(p_360623_.pool());
