...
public class TemptGoal extends Goal {
    ...
    public TemptGoal(PathfinderMob pMob, double pSpeedModifier, Predicate<ItemStack> pItems, boolean pCanScare) {
        this((Mob)pMob, pSpeedModifier, pItems, pCanScare, 2.5);
    }
    ...
    public TemptGoal(PathfinderMob pMob, double pSpeedModifier, Predicate<ItemStack> pItems, boolean pCanScare, double pStopDistance) {
        this((Mob)pMob, pSpeedModifier, pItems, pCanScare, pStopDistance);
    }

    TemptGoal(Mob pMob, double pSpeedModifier, Predicate<ItemStack> pItems, boolean pCanScare, double pStopDistance) {
        this.mob = pMob;
    ...
    protected void navigateTowards(Player pPlayer) {
        this.mob.getNavigation().moveTo(pPlayer, this.speedModifier);
    }
