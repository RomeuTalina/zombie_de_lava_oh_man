...
public abstract class NearestVisibleLivingEntitySensor extends Sensor<LivingEntity> {
    ...
    private Optional<LivingEntity> getNearestEntity(ServerLevel pLevel, LivingEntity pEntity) {
        return this.getVisibleEntities(pEntity).flatMap(p_359113_ -> p_359113_.findClosest(p_359116_ -> this.isMatchingEntity(pLevel, pEntity, p_359116_)));
    }
