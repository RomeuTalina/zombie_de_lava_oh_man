...
public class ChunkGeneratorStructureState {
    ...
    private ChunkGeneratorStructureState(RandomState pRandomState, BiomeSource pBiomeSource, long pLevelSeed, long pConcentricRingsSeed, List<Holder<StructureSet>> pPossibleStructureSets) {
        this.randomState = pRandomState;
        this.levelSeed = pLevelSeed;
        this.biomeSource = pBiomeSource;
        this.concentricRingsSeed = pConcentricRingsSeed;
