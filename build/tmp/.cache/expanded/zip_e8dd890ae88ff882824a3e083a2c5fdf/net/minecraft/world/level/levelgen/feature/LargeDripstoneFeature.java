...
public class LargeDripstoneFeature extends Feature<LargeDripstoneConfiguration> {
    ...
    private static LargeDripstoneFeature.LargeDripstone makeDripstone(
        ...
        return new LargeDripstoneFeature.LargeDripstone(pRoot, pPointingUp, pRadius, pBluntnessBase.sample(pRandom), pScaleBase.sample(pRandom));
    }
    ...
    static final class LargeDripstone {
                    ...
                    if (!(f > this.radius)) {
                        ...
                        if (k > 0) {
                            if (pRandom.nextFloat() < 0.2) {
                                k = (int)(k * Mth.randomBetween(pRandom, 0.8F, 1.0F));
                            }
        ...
        boolean isSuitableForWind(LargeDripstoneConfiguration pConfig) {
            return this.radius >= pConfig.minRadiusForWind && this.bluntness >= pConfig.minBluntnessForWind;
        }
    }
