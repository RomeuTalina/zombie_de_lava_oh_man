...
public class Containers {
    ...
    public static void dropContents(Level pLevel, BlockPos pPos, NonNullList<ItemStack> pStackList) {
        pStackList.forEach(p_19009_ -> dropItemStack(pLevel, pPos.getX(), pPos.getY(), pPos.getZ(), p_19009_));
    }
    ...
    public static void updateNeighboursAfterDestroy(BlockState pState, Level pLevel, BlockPos pPos) {
