    ...
    public static StructureStart loadStaticStart(StructurePieceSerializationContext pContext, CompoundTag pTag, long pSeed) {
        ...
        if ("INVALID".equals(s)) {
            ...
            if (structure == null) {
                ...
                ChunkPos chunkpos = new ChunkPos(pTag.getIntOr("ChunkX", 0), pTag.getIntOr("ChunkZ", 0));
                int i = pTag.getIntOr("references", 0);
                ListTag listtag = pTag.getListOrEmpty("Children");
