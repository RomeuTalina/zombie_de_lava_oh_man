...
public interface SuspiciousEffectHolder {
    ...
    static SuspiciousEffectHolder tryGet(ItemLike pItem) {
        if (pItem.asItem() instanceof BlockItem blockitem && blockitem.getBlock() instanceof SuspiciousEffectHolder suspiciouseffectholder1) {
            return suspiciouseffectholder1;
        } else {
            return pItem.asItem() instanceof SuspiciousEffectHolder suspiciouseffectholder ? suspiciouseffectholder : null;
        }
    }
}