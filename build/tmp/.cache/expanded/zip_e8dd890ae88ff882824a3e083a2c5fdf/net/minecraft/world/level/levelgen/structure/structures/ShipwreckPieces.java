...
public class ShipwreckPieces {
    ...
    public static class ShipwreckPiece extends TemplateStructurePiece {
        ...
        public ShipwreckPiece(StructureTemplateManager pStructureTemplateManager, CompoundTag pTag) {
            super(StructurePieceType.SHIPWRECK_PIECE, pTag, pStructureTemplateManager, p_391081_ -> makeSettings(pTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
            this.isBeached = pTag.getBooleanOr("isBeached", false);
        }
