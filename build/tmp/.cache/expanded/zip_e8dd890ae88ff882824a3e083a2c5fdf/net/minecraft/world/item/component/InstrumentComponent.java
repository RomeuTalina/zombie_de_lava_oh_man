...
public record InstrumentComponent(EitherHolder<Instrument> instrument) implements TooltipProvider {
    ...
    public InstrumentComponent(Holder<Instrument> pInstrument) {
        this(new EitherHolder<>(pInstrument));
    }

    @Deprecated
    public InstrumentComponent(ResourceKey<Instrument> pInstrument) {
        this(new EitherHolder<>(pInstrument));
    }
    ...
    public Optional<Holder<Instrument>> unwrap(HolderLookup.Provider pRegistries) {
        return this.instrument.unwrap(pRegistries);
    }
}