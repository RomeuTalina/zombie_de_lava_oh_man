...
public class LevelTicks<T> implements LevelTickAccess<T> {
    ...
    private void forContainersInArea(BoundingBox pArea, LevelTicks.PosAndContainerConsumer<T> pAction) {
        int i = SectionPos.posToSectionCoord(pArea.minX());
        int j = SectionPos.posToSectionCoord(pArea.minZ());
        int k = SectionPos.posToSectionCoord(pArea.maxX());
        int l = SectionPos.posToSectionCoord(pArea.maxZ());
