...
public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
    ...
    public AvoidEntityGoal(PathfinderMob pMob, Class<T> pAvoidClass, float pMaxDistance, double pWalkSpeedModifier, double pSprintSpeedModifier) {
        this(pMob, pAvoidClass, p_25052_ -> true, pMaxDistance, pWalkSpeedModifier, pSprintSpeedModifier, EntitySelector.NO_CREATIVE_OR_SPECTATOR::test);
    }
    ...
    public AvoidEntityGoal(PathfinderMob pMob, Class<T> pAvoidClass, float pMaxDistance, double pWalkSpeedModifier, double pSprintSpeedModifier, Predicate<LivingEntity> pPredicateOnAvoidEntity) {
        this(pMob, pAvoidClass, p_25049_ -> true, pMaxDistance, pWalkSpeedModifier, pSprintSpeedModifier, pPredicateOnAvoidEntity);
    }
