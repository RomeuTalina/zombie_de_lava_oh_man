...
public class YieldJobSite {
                                ...
                                p_258916_.<List<LivingEntity>>get(p_258903_)
                                    ...
                                    .ifPresent(p_390624_ -> {
                                        ...
                                        if (p_390624_.getBrain().getMemory(MemoryModuleType.JOB_SITE).isEmpty()) {
                                            BehaviorUtils.setWalkAndLookTargetMemories(p_390624_, blockpos, pSpeedModifier, 1);
    ...
    private static boolean nearbyWantsJobsite(Holder<PoiType> pPoi, Villager pVillager, BlockPos pPos) {
        ...
        if (flag) {
            ...
            Holder<VillagerProfession> holder = pVillager.getVillagerData().profession();
            if (holder.value().heldJobSite().test(pPoi)) {
