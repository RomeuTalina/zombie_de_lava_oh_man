...
public class FeatureSorter {
    public static <T> List<FeatureSorter.StepFeatureData> buildFeaturesPerStep(List<T> pFeatureSetSources, Function<T, List<HolderSet<PlacedFeature>>> pToFeatureSetFunction, boolean pNotRecursiveFlag) {
        ...
        for (T t : pFeatureSetSources) {
            ...
            List<HolderSet<PlacedFeature>> list1 = pToFeatureSetFunction.apply(t);
            ...
            if (!set.contains(featuresorter$1featuredata) && Graph.depthFirstSearch(map, set, set1, list2::add, featuresorter$1featuredata)) {
                ...
                do {
                    ...
                    while (listiterator.hasNext()) {
                        ...
                        try {
                            buildFeaturesPerStep(list3, pToFeatureSetFunction, false);
