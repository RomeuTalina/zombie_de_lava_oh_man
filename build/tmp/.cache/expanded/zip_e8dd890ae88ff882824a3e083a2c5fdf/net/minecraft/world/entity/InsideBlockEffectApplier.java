...
public interface InsideBlockEffectApplier {
    ...
    void apply(InsideBlockEffectType pType);

    void runBefore(InsideBlockEffectType pType, Consumer<Entity> pEffect);

    void runAfter(InsideBlockEffectType pType, Consumer<Entity> pEffect);
    ...
    public static class StepBasedCollector implements InsideBlockEffectApplier {
        ...
        public void advanceStep(int pStep) {
            if (this.lastStep != pStep) {
                this.lastStep = pStep;
                this.flushStep();
            }
        }

        public void applyAndClear(Entity pEntity) {
            this.flushStep();
