...
public class DesertPyramidPiece extends ScatteredFeaturePiece {
    ...
    public DesertPyramidPiece(CompoundTag pTag) {
        ...
        this.hasPlacedChest[0] = pTag.getBooleanOr("hasPlacedChest0", false);
        this.hasPlacedChest[1] = pTag.getBooleanOr("hasPlacedChest1", false);
        this.hasPlacedChest[2] = pTag.getBooleanOr("hasPlacedChest2", false);
        this.hasPlacedChest[3] = pTag.getBooleanOr("hasPlacedChest3", false);
    }
