...
public class HappyGhastAi {
    ...
    protected static Brain<?> makeBrain(Brain<HappyGhast> pBrain) {
    ...
    private static void initCoreActivity(Brain<HappyGhast> pBrain) {
        pBrain.addActivity(
            Activity.CORE,
            0,
            ImmutableList.of(
    ...
    private static void initIdleActivity(Brain<HappyGhast> pBrain) {
        pBrain.addActivity(
            Activity.IDLE,
            ImmutableList.of(
    ...
    private static void initPanicActivity(Brain<HappyGhast> pBrain) {
        pBrain.addActivityWithConditions(Activity.PANIC, ImmutableList.of(), Set.of(Pair.of(MemoryModuleType.IS_PANICKING, MemoryStatus.VALUE_PRESENT)));
    }

    public static void updateActivity(HappyGhast pHappyGhast) {
        pHappyGhast.getBrain().setActiveActivityToFirstValid(ImmutableList.of(Activity.PANIC, Activity.IDLE));
    }
}