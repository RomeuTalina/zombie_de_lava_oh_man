...
public abstract class ProjectileWeaponItem extends Item {
    ...
    protected static ItemStack useAmmo(ItemStack pWeapon, ItemStack pAmmo, LivingEntity pShooter, boolean pIntangible) {
        int i = !pIntangible && !pShooter.hasInfiniteMaterials() && pShooter.level() instanceof ServerLevel serverlevel
