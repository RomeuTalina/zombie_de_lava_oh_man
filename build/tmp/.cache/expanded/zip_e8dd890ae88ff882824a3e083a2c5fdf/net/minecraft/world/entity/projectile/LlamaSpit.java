...
public class LlamaSpit extends Projectile {
    ...
    public LlamaSpit(Level pLevel, Llama pSpitter) {
        ...
        this.setPos(
            pSpitter.getX() - (pSpitter.getBbWidth() + 1.0F) * 0.5 * Mth.sin(pSpitter.yBodyRot * (float) (Math.PI / 180.0)),
            pSpitter.getEyeY() - 0.1F,
            pSpitter.getZ() + (pSpitter.getBbWidth() + 1.0F) * 0.5 * Mth.cos(pSpitter.yBodyRot * (float) (Math.PI / 180.0))
        );
    }
