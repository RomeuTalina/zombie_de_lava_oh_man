...
public class SetFireworksFunction extends LootItemConditionalFunction {
    ...
    public SetFireworksFunction(List<LootItemCondition> pConditions, Optional<ListOperation.StandAlone<FireworkExplosion>> pExplosions, Optional<Integer> pFlightDuration) {
        super(pConditions);
