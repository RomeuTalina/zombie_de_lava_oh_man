...
public enum TestBlockMode implements StringRepresentable {
    ...
    private TestBlockMode(final int pId, final String pName) {
        this.id = pId;
        this.name = pName;
        this.displayName = Component.translatable("test_block.mode." + pName);
        this.detailedMessage = Component.translatable("test_block.mode_info." + pName);
    }
