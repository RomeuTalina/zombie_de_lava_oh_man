...
public class ExplorationMapFunction extends LootItemConditionalFunction {
    ...
    ExplorationMapFunction(
        List<LootItemCondition> pConditions, TagKey<Structure> pDestination, Holder<MapDecorationType> pMapDecoration, byte pZoom, int pSearchRadius, boolean pSkipKnownStructures
    ) {
        super(pConditions);
