...
public class FlyNodeEvaluator extends WalkNodeEvaluator {
    ...
    private Iterable<BlockPos> iteratePathfindingStartNodeCandidatePositions(Mob pMob) {
        ...
        if (!flag) {
            return List.of(
                BlockPos.containing(aabb.minX, pMob.getBlockY(), aabb.minZ),
                BlockPos.containing(aabb.minX, pMob.getBlockY(), aabb.maxZ),
                BlockPos.containing(aabb.maxX, pMob.getBlockY(), aabb.minZ),
                BlockPos.containing(aabb.maxX, pMob.getBlockY(), aabb.maxZ)
            );
        } else {
