...
public class FollowTemptation extends Behavior<PathfinderMob> {
    ...
    public FollowTemptation(Function<LivingEntity, Float> pSpeedModifier, Function<LivingEntity, Double> pCloseEnoughDistance) {
        this(pSpeedModifier, pCloseEnoughDistance, false);
    }

    public FollowTemptation(Function<LivingEntity, Float> pSpeedModifier, Function<LivingEntity, Double> pCloseEnoughDistance, boolean pLookInTheEyes) {
        super(Util.make(() -> {
        ...
        this.lookInTheEyes = pLookInTheEyes;
    }
