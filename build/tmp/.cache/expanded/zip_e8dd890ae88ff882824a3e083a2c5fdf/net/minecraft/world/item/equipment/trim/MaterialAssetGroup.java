...
public record MaterialAssetGroup(MaterialAssetGroup.AssetInfo base, Map<ResourceKey<EquipmentAsset>, MaterialAssetGroup.AssetInfo> overrides) {
    ...
    public static MaterialAssetGroup create(String pName) {
        return new MaterialAssetGroup(new MaterialAssetGroup.AssetInfo(pName), Map.of());
    }
    ...
    public static MaterialAssetGroup create(String pName, Map<ResourceKey<EquipmentAsset>, String> pOverrides) {
        return new MaterialAssetGroup(
            new MaterialAssetGroup.AssetInfo(pName), Map.copyOf(Maps.transformValues(pOverrides, MaterialAssetGroup.AssetInfo::new))
        );
    }

    public MaterialAssetGroup.AssetInfo assetId(ResourceKey<EquipmentAsset> pAssetKey) {
        return this.overrides.getOrDefault(pAssetKey, this.base);
    }
