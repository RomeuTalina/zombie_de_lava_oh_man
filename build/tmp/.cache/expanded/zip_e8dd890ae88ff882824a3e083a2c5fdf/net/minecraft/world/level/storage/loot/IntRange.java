...
public class IntRange {
    ...
    public static IntRange range(int pMin, int pMax) {
        return new IntRange(Optional.of(ConstantValue.exactly(pMin)), Optional.of(ConstantValue.exactly(pMax)));
    }

    public static IntRange lowerBound(int pMin) {
        return new IntRange(Optional.of(ConstantValue.exactly(pMin)), Optional.empty());
    }

    public static IntRange upperBound(int pMax) {
        return new IntRange(Optional.empty(), Optional.of(ConstantValue.exactly(pMax)));
    }
