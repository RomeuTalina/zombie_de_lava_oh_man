...
public class LongJumpToRandomPos<E extends Mob> extends Behavior<E> {
    ...
    protected Optional<LongJumpToRandomPos.PossibleJump> getJumpCandidate(ServerLevel pLevel) {
        Optional<LongJumpToRandomPos.PossibleJump> optional = WeightedRandom.getRandomItem(
            pLevel.random, this.jumpCandidates, LongJumpToRandomPos.PossibleJump::weight
        );
    ...
    protected Vec3 calculateOptimalJumpVector(Mob pMob, Vec3 pTarget) {
        ...
        float f = (float)(pMob.getAttributeValue(Attributes.JUMP_STRENGTH) * this.maxJumpVelocityMultiplier);
