...
public class UntintedParticleLeavesBlock extends LeavesBlock {
    ...
    public UntintedParticleLeavesBlock(float pLeafParticleChance, ParticleOptions pLeafParticle, BlockBehaviour.Properties pProperties) {
        super(pLeafParticleChance, pProperties);
        this.leafParticle = pLeafParticle;
    }
