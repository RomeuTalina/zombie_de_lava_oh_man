...
public abstract class ThrowablePotionItem extends PotionItem implements ProjectileItem {
    ...
    protected abstract AbstractThrownPotion createPotion(ServerLevel pLevel, LivingEntity pEntity, ItemStack pStack);

    protected abstract AbstractThrownPotion createPotion(Level pLevel, Position pPosition, ItemStack pStack);
