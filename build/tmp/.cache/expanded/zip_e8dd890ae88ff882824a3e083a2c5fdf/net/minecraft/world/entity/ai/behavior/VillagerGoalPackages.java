...
public class VillagerGoalPackages {
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getCorePackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
        return ImmutableList.of(
            ...
            Pair.of(0, ValidateNearbyPoi.create(pProfession.value().heldJobSite(), MemoryModuleType.JOB_SITE)),
            Pair.of(0, ValidateNearbyPoi.create(pProfession.value().acquirableJobSite(), MemoryModuleType.POTENTIAL_JOB_SITE)),
            ...
            Pair.of(
                6,
                AcquirePoi.create(
                    pProfession.value().acquirableJobSite(),
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getWorkPackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
        WorkAtPoi workatpoi;
        if (pProfession.is(VillagerProfession.FARMER)) {
            ...
            Pair.of(
                ...
                new RunOne<>(
                    ImmutableList.of(
                        ...
                        Pair.of(new HarvestFarmland(), pProfession.is(VillagerProfession.FARMER) ? 2 : 5),
                        Pair.of(new UseBonemeal(), pProfession.is(VillagerProfession.FARMER) ? 4 : 7)
                    )
                )
            ),
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getRestPackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
        return ImmutableList.of(
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getMeetPackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
        return ImmutableList.of(
            Pair.of(
                2,
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getIdlePackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
        return ImmutableList.of(
            Pair.of(
                2,
                new RunOne<>(
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getPanicPackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getPreRaidPackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
        return ImmutableList.of(
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getRaidPackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
        return ImmutableList.of(
            Pair.of(
                0,
    ...
    public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getHidePackage(Holder<VillagerProfession> pProfession, float pSpeedModifier) {
        int i = 2;
