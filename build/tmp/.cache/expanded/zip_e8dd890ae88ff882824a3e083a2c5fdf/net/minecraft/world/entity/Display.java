...
public abstract class Display extends Entity {
    ...
    public static class TextDisplay extends Display {
        ...
        private static byte loadFlag(byte pFlags, ValueInput pInput, String pKey, byte pMask) {
            return pInput.getBooleanOr(pKey, false) ? (byte)(pFlags | pMask) : pFlags;
        }
        ...
        private static void storeFlag(byte pFlags, ValueOutput pOutput, String pKey, byte pName) {
            pOutput.putBoolean(pKey, (pFlags & pName) != 0);
        }
