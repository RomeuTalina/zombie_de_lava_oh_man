...
public final class VillagerType {
    ...
    private static ResourceKey<VillagerType> createKey(String pName) {
        return ResourceKey.create(Registries.VILLAGER_TYPE, ResourceLocation.withDefaultNamespace(pName));
    }

    private static VillagerType register(Registry<VillagerType> pRegistry, ResourceKey<VillagerType> pKey) {
        return Registry.register(pRegistry, pKey, new VillagerType());
    }

    public static VillagerType bootstrap(Registry<VillagerType> pRegistry) {
        register(pRegistry, DESERT);
        register(pRegistry, JUNGLE);
        register(pRegistry, PLAINS);
        register(pRegistry, SAVANNA);
        register(pRegistry, SNOW);
        register(pRegistry, SWAMP);
        return register(pRegistry, TAIGA);
    }

    public static ResourceKey<VillagerType> byBiome(Holder<Biome> pBiome) {
