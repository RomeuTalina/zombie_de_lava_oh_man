...
public abstract class DiscreteVoxelShape {
    ...
    public DiscreteVoxelShape rotate(OctahedralGroup pOctahedralGroup) {
        if (pOctahedralGroup == OctahedralGroup.IDENTITY) {
            return this;
        } else {
            Direction.Axis direction$axis = pOctahedralGroup.permute(Direction.Axis.X);
            Direction.Axis direction$axis1 = pOctahedralGroup.permute(Direction.Axis.Y);
            Direction.Axis direction$axis2 = pOctahedralGroup.permute(Direction.Axis.Z);
            ...
            boolean flag = pOctahedralGroup.inverts(direction$axis);
            boolean flag1 = pOctahedralGroup.inverts(direction$axis1);
            boolean flag2 = pOctahedralGroup.inverts(direction$axis2);
