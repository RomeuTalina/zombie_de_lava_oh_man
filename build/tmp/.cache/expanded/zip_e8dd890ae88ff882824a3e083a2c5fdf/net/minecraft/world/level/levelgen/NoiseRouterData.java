...
public class NoiseRouterData {
    ...
    private static NoiseRouter noNewCaves(
        HolderGetter<DensityFunction> pDensityFunctions, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters, DensityFunction pPostProcessor
    ) {
        ...
        DensityFunction densityfunction4 = postProcess(pPostProcessor);
        return new NoiseRouter(
