...
public class ModelProvider implements DataProvider {
    ...
    public static class BlockStateGeneratorCollector implements Consumer<BlockModelDefinitionGenerator> {
        ...
        public void accept(BlockModelDefinitionGenerator pGenerator) {
            Block block = pGenerator.block();
            BlockModelDefinitionGenerator blockmodeldefinitiongenerator = this.generators.put(block, pGenerator);
    ...
    public static class SimpleModelCollector implements BiConsumer<ResourceLocation, ModelInstance> {
        ...
        public void accept(ResourceLocation pLocation, ModelInstance pModel) {
            Supplier<JsonElement> supplier = this.models.put(pLocation, pModel);
            if (supplier != null) {
                throw new IllegalStateException("Duplicate model definition for " + pLocation);
            }
        }
