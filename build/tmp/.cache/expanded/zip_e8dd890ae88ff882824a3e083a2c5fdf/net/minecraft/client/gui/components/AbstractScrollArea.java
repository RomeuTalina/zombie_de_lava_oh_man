...
public abstract class AbstractScrollArea extends AbstractWidget {
    ...
    protected void renderScrollbar(GuiGraphics pGuiGraphics) {
        if (this.scrollbarVisible()) {
            ...
            pGuiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, SCROLLER_BACKGROUND_SPRITE, i, this.getY(), 6, this.getHeight());
            pGuiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, SCROLLER_SPRITE, i, k, 6, j);
        }
    }
