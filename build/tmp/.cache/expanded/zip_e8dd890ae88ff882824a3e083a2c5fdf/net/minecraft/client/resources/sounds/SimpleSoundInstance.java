...
public class SimpleSoundInstance extends AbstractSoundInstance {
    ...
    public static SimpleSoundInstance forMusic(SoundEvent pSound, float pVolume) {
        return new SimpleSoundInstance(
            pSound.location(), SoundSource.MUSIC, pVolume, 1.0F, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0, 0.0, 0.0, true
        );
    }
