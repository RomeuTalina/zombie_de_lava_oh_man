...
public record BlockModel(
    ...
    public static class Deserializer implements JsonDeserializer<BlockModel> {
        public BlockModel deserialize(JsonElement pJson, Type pType, JsonDeserializationContext pContext) throws JsonParseException {
            ...
            UnbakedGeometry unbakedgeometry = this.getElements(pContext, jsonobject);
            ...
            var forgeData = net.minecraftforge.client.ForgeHooksClient.deserializeBlockModel(jsonobject, pContext);
        ...
        @Nullable
        protected UnbakedGeometry getElements(JsonDeserializationContext pContext, JsonObject pJson) {
            var geo = net.minecraftforge.client.ForgeHooksClient.deserializeBlockModelGeometry(pJson, pContext);
            if (geo != null)
                return geo;
