...
public class LocalPlayer extends AbstractClientPlayer {
    ...
    public LocalPlayer(
        ...
        this.lastSentInput = pLastSentInput;
        ...
        this.ambientSoundHandlers.add(new BiomeAmbientSoundsHandler(this, pMinecraft.getSoundManager(), pLevel.getBiomeManager()));
    }
    ...
    public boolean startRiding(Entity pEntity, boolean pForce) {
        if (!super.startRiding(pEntity, pForce)) {
            ...
            } else if (pEntity instanceof HappyGhast) {
                this.minecraft.getSoundManager().play(new RidingHappyGhastSoundInstance(this, (HappyGhast)pEntity));
            }
