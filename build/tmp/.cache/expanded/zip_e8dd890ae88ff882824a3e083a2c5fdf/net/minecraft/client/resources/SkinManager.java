...
public class SkinManager {
    ...
    public PlayerSkin getInsecureSkin(GameProfile pProfile) {
        PlayerSkin playerskin = this.getInsecureSkin(pProfile, null);
        return playerskin != null ? playerskin : DefaultPlayerSkin.get(pProfile);
    }

    @Nullable
    public PlayerSkin getInsecureSkin(GameProfile pProfile, @Nullable PlayerSkin pDefaultSkin) {
        return this.getOrLoad(pProfile).getNow(Optional.empty()).orElse(pDefaultSkin);
    }
