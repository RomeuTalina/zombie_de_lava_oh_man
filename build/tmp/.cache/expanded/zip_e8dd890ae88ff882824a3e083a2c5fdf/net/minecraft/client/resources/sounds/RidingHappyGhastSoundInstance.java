...
public class RidingHappyGhastSoundInstance extends AbstractTickableSoundInstance {
    ...
    public RidingHappyGhastSoundInstance(Player pPlayer, HappyGhast pHappyGhast) {
        super(SoundEvents.HAPPY_GHAST_RIDING, pHappyGhast.getSoundSource(), SoundInstance.createUnseededRandom());
        this.player = pPlayer;
        this.happyGhast = pHappyGhast;
