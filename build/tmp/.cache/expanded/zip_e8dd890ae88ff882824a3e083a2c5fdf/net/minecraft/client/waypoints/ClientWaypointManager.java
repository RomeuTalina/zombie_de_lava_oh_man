...
public class ClientWaypointManager implements TrackedWaypointManager {
    ...
    public void forEachWaypoint(Entity pEntity, Consumer<TrackedWaypoint> pAction) {
        this.waypoints
            .values()
            .stream()
            .sorted(Comparator.<TrackedWaypoint>comparingDouble(p_410125_ -> p_410125_.distanceSquared(pEntity)).reversed())
            .forEachOrdered(pAction);
    }
}