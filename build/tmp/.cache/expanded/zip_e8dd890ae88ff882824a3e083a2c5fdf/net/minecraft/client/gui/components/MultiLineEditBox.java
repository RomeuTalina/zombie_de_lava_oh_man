...
public class MultiLineEditBox extends AbstractTextAreaWidget {
    ...
    MultiLineEditBox(
        ...
        boolean pTextShadow,
        int pCursorColor,
        boolean pShowBackground,
        boolean pShowDecorations
    ) {
        super(pX, pY, pWidth, pHeight, pMessage, pShowBackground, pShowDecorations);
        this.font = pFont;
        this.textShadow = pTextShadow;
    ...
    public void setLineLimit(int pLineLimit) {
        this.textField.setLineLimit(pLineLimit);
    }
    ...
    public void setValue(String pValue, boolean pForce) {
        this.textField.setValue(pValue, pForce);
    }
    ...
    public static class Builder {
        ...
        public MultiLineEditBox.Builder setX(int pX) {
            this.x = pX;
            return this;
        }

        public MultiLineEditBox.Builder setY(int pY) {
            this.y = pY;
            return this;
        }

        public MultiLineEditBox.Builder setPlaceholder(Component pPlaceholder) {
            this.placeholder = pPlaceholder;
            return this;
        }

        public MultiLineEditBox.Builder setTextColor(int pTextColor) {
            this.textColor = pTextColor;
            return this;
        }

        public MultiLineEditBox.Builder setTextShadow(boolean pTextShadow) {
            this.textShadow = pTextShadow;
            return this;
        }

        public MultiLineEditBox.Builder setCursorColor(int pCursorColor) {
            this.cursorColor = pCursorColor;
            return this;
        }

        public MultiLineEditBox.Builder setShowBackground(boolean pShowBackground) {
            this.showBackground = pShowBackground;
            return this;
        }

        public MultiLineEditBox.Builder setShowDecorations(boolean pShowDecorations) {
            this.showDecorations = pShowDecorations;
            return this;
        }

        public MultiLineEditBox build(Font pFont, int pWidth, int pHeight, Component pMessage) {
