...
public class LoadingTab implements Tab {
    ...
    public LoadingTab(Font pFont, Component pTitle, Component pLoadingTitle) {
        this.title = pTitle;
        this.loadingTitle = pLoadingTitle;
        LoadingDotsWidget loadingdotswidget = new LoadingDotsWidget(pFont, pLoadingTitle);
