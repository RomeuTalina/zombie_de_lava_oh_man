...
public class ChatListener {
    ...
    public void handleChatMessageError(UUID pSender, @Nullable MessageSignature pSignature, ChatType.Bound pBoundChatType) {
        this.handleMessage(null, () -> {
            ...
            if (this.minecraft.isBlocked(pSender)) {
                ...
                this.minecraft.getNarrator().saySystemChatQueued(pBoundChatType.decorateNarration(CHAT_VALIDATION_ERROR));
    ...
    private void narrateChatMessage(ChatType.Bound pBoundChatType, Component pMessage) {
        this.minecraft.getNarrator().sayChatQueued(pBoundChatType.decorateNarration(pMessage));
    }
    ...
    public void handleSystemMessage(Component pMessage, boolean pIsOverlay) {
        if (!this.minecraft.options.hideMatchedNames().get() || !this.minecraft.isBlocked(this.guessChatUUID(pMessage))) {
            ...
            if (pIsOverlay) {
                ...
                this.minecraft.getNarrator().saySystemChatQueued(pMessage);
            }
        }
    }
