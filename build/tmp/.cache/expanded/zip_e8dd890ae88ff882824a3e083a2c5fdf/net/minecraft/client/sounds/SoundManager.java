...
public class SoundManager extends SimplePreparableReloadListener<SoundManager.Preparations> {
    ...
    public SoundManager(Options pOptions, MusicManager pMusicManager) {
        this.soundEngine = new SoundEngine(pMusicManager, this, pOptions, ResourceProvider.fromMap(this.soundCache));
    }
    ...
    public SoundEngine.PlayResult play(SoundInstance pSound) {
        return this.soundEngine.play(pSound);
    }
    ...
    public void pauseAllExcept(SoundSource... pSoundSources) {
        this.soundEngine.pauseAllExcept(pSoundSources);
    }
