...
public class FocusableTextWidget extends MultiLineTextWidget {
    ...
    public FocusableTextWidget(int pMaxWidth, Component pMessage, Font pFont, int pPadding) {
        this(pMaxWidth, pMessage, pFont, true, true, pPadding);
    }

    public FocusableTextWidget(int pMaxWidth, Component pMessage, Font pFont, boolean pAlwaysShowBorder, boolean pFillBackground, int pPadding) {
        super(pMessage, pFont);
        this.setMaxWidth(pMaxWidth);
        this.setCentered(true);
        this.active = true;
        this.alwaysShowBorder = pAlwaysShowBorder;
        this.fillBackground = pFillBackground;
