...
public class SpriteLoader {
    ...
    public CompletableFuture<SpriteLoader.Preparations> loadAndStitch(ResourceManager pResourceManager, ResourceLocation pLocation, int pMipLevel, Executor pExecutor) {
        return this.loadAndStitch(pResourceManager, pLocation, pMipLevel, pExecutor, DEFAULT_METADATA_SECTIONS);
    }
