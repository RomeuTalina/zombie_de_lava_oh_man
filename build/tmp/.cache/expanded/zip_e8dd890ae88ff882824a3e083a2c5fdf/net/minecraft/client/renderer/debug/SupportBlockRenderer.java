...
public class SupportBlockRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    private double getBias(Entity pEntity) {
        return 0.02 * (String.valueOf(pEntity.getId() + 0.132453657).hashCode() % 1000) / 1000.0;
    }
    ...
    private void highlightPosition(
        ...
        double d0 = pPos.getX() - pCamX - 2.0 * pBias;
        double d1 = pPos.getY() - pCamY - 2.0 * pBias;
        double d2 = pPos.getZ() - pCamZ - 2.0 * pBias;
        ...
        DebugRenderer.renderVoxelShape(
            ...
            this.minecraft.level.getBlockState(pPos).getCollisionShape(this.minecraft.level, pPos, CollisionContext.empty()).move(pPos),
            -pCamX,
            -pCamY,
            -pCamZ,
            pRed,
