...
public class BiomeColors {
    ...
    public static int getAverageDryFoliageColor(BlockAndTintGetter pLevel, BlockPos pBlockPos) {
        return getAverageColor(pLevel, pBlockPos, DRY_FOLIAGE_COLOR_RESOLVER);
    }
