            ...
            .forEach(
                p_405018_ -> {
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::attackTarget)
                        ...
                        .ifPresent(
                            p_310972_ -> {
                                drawLine(pPoseStack, pBuffer, pXOffset, pYOffset, pZOffset, p_405018_.position(), p_310972_, TARGET_LINE_COLOR);
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::jumpTarget)
                        .ifPresent(
                            p_405011_ -> {
                                drawLine(pPoseStack, pBuffer, pXOffset, pYOffset, pZOffset, p_405018_.position(), p_405011_.getCenter(), JUMP_TARGET_LINE_COLOR);
                                DebugRenderer.renderFilledBox(
                                    pPoseStack,
                                    pBuffer,
                                    AABB.unitCubeFromLowerCorner(Vec3.atLowerCornerOf(p_405011_)).move(-pXOffset, -pYOffset, -pZOffset),
                                    1.0F,
                                    0.0F,
                                    0.0F,
                                    1.0F
