...
public interface BlockStateModel extends net.minecraftforge.client.extensions.IForgeBlockStateModel {
    ...
    @Deprecated
    void collectParts(RandomSource pRandom, List<BlockModelPart> pOutput);
    ...
    @Deprecated
    default List<BlockModelPart> collectParts(RandomSource pRandom) {
        List<BlockModelPart> list = new ObjectArrayList<>();
        this.collectParts(pRandom, list, net.minecraftforge.client.model.data.ModelData.EMPTY, null);
        return list;
    }
    ...
    public static class SimpleCachedUnbakedRoot implements BlockStateModel.UnbakedRoot {
        ...
        public SimpleCachedUnbakedRoot(BlockStateModel.Unbaked pContents) {
    ...
    public interface Unbaked extends ResolvableModel {
        ...
        BlockStateModel bake(ModelBaker pBaker);
    ...
    public interface UnbakedRoot extends ResolvableModel {
        BlockStateModel bake(BlockState pState, ModelBaker pBaker);
