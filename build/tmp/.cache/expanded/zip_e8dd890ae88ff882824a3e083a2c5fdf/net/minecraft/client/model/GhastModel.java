...
public class GhastModel extends EntityModel<GhastRenderState> {
    ...
    public GhastModel(ModelPart pRoot) {
        ...
        for (int i = 0; i < this.tentacles.length; i++) {
            this.tentacles[i] = pRoot.getChild(PartNames.tentacle(i));
        }
    }
    ...
    public static void animateTentacles(EntityRenderState pRenderState, ModelPart[] pTentacles) {
        for (int i = 0; i < pTentacles.length; i++) {
            pTentacles[i].xRot = 0.2F * Mth.sin(pRenderState.ageInTicks * 0.3F + i) + 0.4F;
        }
    }
}