...
public class KeyMapping implements Comparable<KeyMapping>, net.minecraftforge.client.extensions.IForgeKeyMapping {
    ...
    public int compareTo(KeyMapping pOther) {
        return this.category.equals(pOther.category)
            ? I18n.get(this.name).compareTo(I18n.get(pOther.name))
            : compareSort(this.category, pOther.category);
    }
