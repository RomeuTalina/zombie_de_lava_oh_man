...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon, EnderDragonRenderState> {
    ...
    public static void renderCrystalBeams(
        ...
        pPoseStack.mulPose(Axis.YP.rotation((float)(-Math.atan2(pOffsetZ, pOffsetX)) - (float) (Math.PI / 2)));
        pPoseStack.mulPose(Axis.XP.rotation((float)(-Math.atan2(f, pOffsetY)) - (float) (Math.PI / 2)));
