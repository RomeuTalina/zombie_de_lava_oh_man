...
public class SheepWoolUndercoatLayer extends RenderLayer<SheepRenderState, SheepModel> {
    ...
    public SheepWoolUndercoatLayer(RenderLayerParent<SheepRenderState, SheepModel> pRenderer, EntityModelSet pModelSet) {
        super(pRenderer);
        this.adultModel = new SheepFurModel(pModelSet.bakeLayer(ModelLayers.SHEEP_WOOL_UNDERCOAT));
        this.babyModel = new SheepFurModel(pModelSet.bakeLayer(ModelLayers.SHEEP_BABY_WOOL_UNDERCOAT));
    }
