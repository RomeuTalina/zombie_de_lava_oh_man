...
public enum BlockModelRotation implements ModelState {
    ...
    private BlockModelRotation(final Quadrant pXRotation, final Quadrant pYRotation) {
        this.xRotation = pXRotation;
        this.yRotation = pYRotation;
        this.actualRotation = OctahedralGroup.fromXYAngles(pXRotation, pYRotation);
    ...
    public static BlockModelRotation by(Quadrant pXRot, Quadrant pYRot) {
        return XY_TABLE[pXRot.ordinal()][pYRot.ordinal()];
    }
