...
public class FontManager implements PreparableReloadListener, AutoCloseable {
    ...
    private void apply(FontManager.Preparation pPreparation, ProfilerFiller pProfiler) {
        ...
        pPreparation.fontSets().forEach((p_325349_, p_325350_) -> {
        ...
        this.providersToClose.addAll(pPreparation.allProviders);
        pProfiler.pop();
