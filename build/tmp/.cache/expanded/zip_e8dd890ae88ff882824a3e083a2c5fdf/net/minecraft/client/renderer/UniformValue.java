...
public interface UniformValue {
    ...
    void writeTo(Std140Builder pBuilder);

    void addSize(Std140SizeCalculator pBuilder);
    ...
    public static enum Type implements StringRepresentable {
        ...
        private Type(final String pName, final Codec<? extends UniformValue> pCodec) {
            this.name = pName;
            this.valueCodec = pCodec.fieldOf("value");
        }
