...
public final class ModelPart {
    ...
    public void getExtentsForGui(PoseStack pPoseStack, Set<Vector3f> pOutput) {
        this.visit(pPoseStack, (p_404875_, p_404876_, p_404877_, p_404878_) -> {
    ...
    private void addAllChildren(BiConsumer<String, ModelPart> pAdder) {
        for (Entry<String, ModelPart> entry : this.children.entrySet()) {
            pAdder.accept(entry.getKey(), entry.getValue());
        }

        for (ModelPart modelpart : this.children.values()) {
            modelpart.addAllChildren(pAdder);
        }
    }
