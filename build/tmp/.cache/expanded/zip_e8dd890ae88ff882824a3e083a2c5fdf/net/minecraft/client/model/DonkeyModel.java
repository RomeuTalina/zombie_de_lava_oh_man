...
public class DonkeyModel extends AbstractEquineModel<DonkeyRenderState> {
    ...
    public static LayerDefinition createBodyLayer(float pScale) {
        return LayerDefinition.create(AbstractEquineModel.createBodyMesh(CubeDeformation.NONE), 64, 64)
            ...
            .apply(MeshTransformer.scaling(pScale));
    }
    ...
    public static LayerDefinition createSaddleLayer(float pScale, boolean pIsBaby) {
        return EquineSaddleModel.createFullScaleSaddleLayer(pIsBaby)
            .apply(DONKEY_TRANSFORMER)
            .apply(pIsBaby ? AbstractEquineModel.BABY_TRANSFORMER : MeshTransformer.IDENTITY)
            .apply(MeshTransformer.scaling(pScale));
    }
