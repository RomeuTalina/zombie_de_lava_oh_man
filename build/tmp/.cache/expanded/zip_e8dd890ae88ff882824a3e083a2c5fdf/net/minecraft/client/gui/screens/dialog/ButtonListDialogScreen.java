...
public abstract class ButtonListDialogScreen<T extends ButtonListDialog> extends DialogScreen<T> {
    ...
    public ButtonListDialogScreen(@Nullable Screen pPreviousScreen, T pDialog, DialogConnectionAccess pConnectionAccess) {
    ...
    protected abstract Stream<ActionButton> createListActions(T pDialog, DialogConnectionAccess pConnectionAccess);
