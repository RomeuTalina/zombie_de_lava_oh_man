...
public class ArmadilloModel extends EntityModel<ArmadilloRenderState> {
    ...
    public ArmadilloModel(ModelPart pRoot) {
        ...
        this.walkAnimation = ArmadilloAnimation.ARMADILLO_WALK.bake(pRoot);
        this.rollOutAnimation = ArmadilloAnimation.ARMADILLO_ROLL_OUT.bake(pRoot);
        this.rollUpAnimation = ArmadilloAnimation.ARMADILLO_ROLL_UP.bake(pRoot);
        this.peekAnimation = ArmadilloAnimation.ARMADILLO_PEEK.bake(pRoot);
    }
