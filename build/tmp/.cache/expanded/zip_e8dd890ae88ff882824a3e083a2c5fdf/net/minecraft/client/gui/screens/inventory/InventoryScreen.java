...
public class InventoryScreen extends AbstractRecipeBookScreen<InventoryMenu> {
    ...
    public static void renderEntityInInventoryFollowsMouse(
        ...
        float f10 = pScale / f9;
        renderEntityInInventory(pGuiGraphics, pX1, pY1, pX2, pY2, f10, vector3f, quaternionf, quaternionf1, pEntity);
        pEntity.yBodyRot = f4;
        pEntity.setYRot(f5);
        pEntity.setXRot(f6);
    ...
    public static void renderEntityInInventory(
        ...
        EntityRenderer<? super LivingEntity, ?> entityrenderer = entityrenderdispatcher.getRenderer(pEntity);
        EntityRenderState entityrenderstate = entityrenderer.createRenderState(pEntity, 1.0F);
        entityrenderstate.hitboxesRenderState = null;
        pGuiGraphics.submitEntityRenderState(entityrenderstate, pScale, pTranslation, pRotation, pOverrideCameraAngle, pX1, pY1, pX2, pY2);
    }
