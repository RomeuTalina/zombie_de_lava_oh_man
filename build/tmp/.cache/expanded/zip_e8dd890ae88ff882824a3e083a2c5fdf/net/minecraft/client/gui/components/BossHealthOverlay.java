...
public class BossHealthOverlay {
    ...
    public void render(GuiGraphics pGuiGraphics) {
        if (!this.events.isEmpty()) {
            ...
            for (LerpingBossEvent lerpingbossevent : this.events.values()) {
                ...
                int i1 = i / 2 - l / 2;
                int j1 = j - 9;
                pGuiGraphics.drawString(this.minecraft.font, component, i1, j1, -1);
                }
    ...
    private void drawBar(
        ...
        pGuiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, pBarProgressSprites[pBossEvent.getColor().ordinal()], 182, 5, 0, 0, pX, pY, pProgress, 5);
        if (pBossEvent.getOverlay() != BossEvent.BossBarOverlay.PROGRESS) {
            pGuiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, pOverlayProgressSprites[pBossEvent.getOverlay().ordinal() - 1], 182, 5, 0, 0, pX, pY, pProgress, 5);
        }
    }
