...
public class BreezeModel extends EntityModel<BreezeRenderState> {
    ...
    public BreezeModel(ModelPart pRoot) {
        ...
        this.idleAnimation = BreezeAnimation.IDLE.bake(pRoot);
        this.shootAnimation = BreezeAnimation.SHOOT.bake(pRoot);
        this.slideAnimation = BreezeAnimation.SLIDE.bake(pRoot);
        this.slideBackAnimation = BreezeAnimation.SLIDE_BACK.bake(pRoot);
        this.inhaleAnimation = BreezeAnimation.INHALE.bake(pRoot);
        this.jumpAnimation = BreezeAnimation.JUMP.bake(pRoot);
    }
