...
public class ScrollableLayout implements Layout {
    ...
    public ScrollableLayout(Minecraft pMinecraft, Layout pContent, int pHeight) {
        ...
        this.container = new ScrollableLayout.Container(pMinecraft, 0, pHeight);
    }

    public void setMinWidth(int pMinWidth) {
        this.minWidth = pMinWidth;
        this.container.setWidth(Math.max(this.content.getWidth(), pMinWidth));
    }

    public void setMaxHeight(int pMaxHeight) {
        this.maxHeight = pMaxHeight;
        this.container.setHeight(Math.min(this.content.getHeight(), pMaxHeight));
    ...
    class Container extends AbstractContainerWidget {
        ...
        public Container(final Minecraft pMinecraft, final int pWidth, final int pHeight) {
