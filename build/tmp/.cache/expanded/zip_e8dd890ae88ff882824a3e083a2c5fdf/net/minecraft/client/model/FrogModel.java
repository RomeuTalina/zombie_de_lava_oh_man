...
public class FrogModel extends EntityModel<FrogRenderState> {
    ...
    public FrogModel(ModelPart pRoot) {
        ...
        this.jumpAnimation = FrogAnimation.FROG_JUMP.bake(pRoot);
        this.croakAnimation = FrogAnimation.FROG_CROAK.bake(pRoot);
        this.tongueAnimation = FrogAnimation.FROG_TONGUE.bake(pRoot);
        this.swimAnimation = FrogAnimation.FROG_SWIM.bake(pRoot);
        this.walkAnimation = FrogAnimation.FROG_WALK.bake(pRoot);
        this.idleWaterAnimation = FrogAnimation.FROG_IDLE_WATER.bake(pRoot);
    }
