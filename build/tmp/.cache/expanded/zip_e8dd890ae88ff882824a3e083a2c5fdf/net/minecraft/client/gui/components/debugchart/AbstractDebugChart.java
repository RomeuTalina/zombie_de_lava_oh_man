...
public abstract class AbstractDebugChart {
    ...
    public void drawChart(GuiGraphics pGuiGraphics, int pX, int pWidth) {
        ...
        pGuiGraphics.fill(pX, i - 60, pX + pWidth, i, -1873784752);
        long j = 0L;
        long k = 2147483647L;
        long l = -2147483648L;
        ...
        pGuiGraphics.hLine(pX, pX + pWidth - 1, i - 60, -1);
        pGuiGraphics.hLine(pX, pX + pWidth - 1, i - 1, -1);
        pGuiGraphics.vLine(pX, i - 60, i, -1);
        pGuiGraphics.vLine(pX + pWidth - 1, i - 60, i, -1);
        if (j1 > 0) {
            String s = this.toDisplayString(k) + " min";
            String s1 = this.toDisplayString((double)j / j1) + " avg";
            String s2 = this.toDisplayString(l) + " max";
            pGuiGraphics.drawString(this.font, s, pX + 2, i - 60 - 9, -2039584);
            pGuiGraphics.drawCenteredString(this.font, s1, pX + pWidth / 2, i - 60 - 9, -2039584);
            pGuiGraphics.drawString(this.font, s2, pX + pWidth - this.font.width(s2) - 2, i - 60 - 9, -2039584);
        }
    ...
    protected void drawMainDimension(GuiGraphics pGuiGraphics, int pHeight, int pX, int pIndex) {
        ...
        pGuiGraphics.fill(pX, pHeight - j, pX + 1, pHeight, k);
    }
    ...
    protected void drawStringWithShade(GuiGraphics pGuiGraphics, String pText, int pX, int pY) {
        pGuiGraphics.fill(pX, pY, pX + this.font.width(pText) + 1, pY + 9, -1873784752);
        pGuiGraphics.drawString(this.font, pText, pX + 1, pY + 1, -2039584, false);
    }
