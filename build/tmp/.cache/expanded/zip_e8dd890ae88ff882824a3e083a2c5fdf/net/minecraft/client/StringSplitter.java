...
public class StringSplitter {
    ...
    public int plainIndexAtWidth(String pContent, int pMaxWidth, Style pStyle) {
        StringSplitter.WidthLimitedCharSink stringsplitter$widthlimitedcharsink = new StringSplitter.WidthLimitedCharSink(pMaxWidth);
    ...
    public FormattedText headByWidth(FormattedText pContent, int pMaxWidth, Style pStyle) {
        final StringSplitter.WidthLimitedCharSink stringsplitter$widthlimitedcharsink = new StringSplitter.WidthLimitedCharSink(pMaxWidth);
    ...
    public int findLineBreak(String pContent, int pMaxWidth, Style pStyle) {
        StringSplitter.LineBreakFinder stringsplitter$linebreakfinder = new StringSplitter.LineBreakFinder(pMaxWidth);
