...
public class WardenModel extends EntityModel<WardenRenderState> {
    ...
    public WardenModel(ModelPart pRoot) {
        ...
        this.attackAnimation = WardenAnimation.WARDEN_ATTACK.bake(pRoot);
        this.sonicBoomAnimation = WardenAnimation.WARDEN_SONIC_BOOM.bake(pRoot);
        this.diggingAnimation = WardenAnimation.WARDEN_DIG.bake(pRoot);
        this.emergeAnimation = WardenAnimation.WARDEN_EMERGE.bake(pRoot);
        this.roarAnimation = WardenAnimation.WARDEN_ROAR.bake(pRoot);
        this.sniffAnimation = WardenAnimation.WARDEN_SNIFF.bake(pRoot);
    }
