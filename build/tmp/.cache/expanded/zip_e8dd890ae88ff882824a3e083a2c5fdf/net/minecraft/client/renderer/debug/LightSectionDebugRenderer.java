...
public class LightSectionDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    private static void renderFace(
        ...
        float f = (float)(SectionPos.sectionToBlockCoord(pBlockX) - pCamX);
        float f1 = (float)(SectionPos.sectionToBlockCoord(pBlockY) - pCamY);
        float f2 = (float)(SectionPos.sectionToBlockCoord(pBlockZ) - pCamZ);
    ...
    private static void renderEdge(
        ...
        float f = (float)(SectionPos.sectionToBlockCoord(pX1) - pCamX);
        float f1 = (float)(SectionPos.sectionToBlockCoord(pY1) - pCamY);
        float f2 = (float)(SectionPos.sectionToBlockCoord(pZ1) - pCamZ);
        float f3 = (float)(SectionPos.sectionToBlockCoord(pX2) - pCamX);
        float f4 = (float)(SectionPos.sectionToBlockCoord(pY2) - pCamY);
        float f5 = (float)(SectionPos.sectionToBlockCoord(pZ2) - pCamZ);
