...
public class EquineSaddleModel extends AbstractEquineModel<EquineRenderState> {
    ...
    public static LayerDefinition createSaddleLayer(boolean pIsBaby) {
        return createFullScaleSaddleLayer(pIsBaby).apply(pIsBaby ? BABY_TRANSFORMER : MeshTransformer.IDENTITY);
    }

    public static LayerDefinition createFullScaleSaddleLayer(boolean pIsBaby) {
        MeshDefinition meshdefinition = pIsBaby ? createFullScaleBabyMesh(CubeDeformation.NONE) : createBodyMesh(CubeDeformation.NONE);
