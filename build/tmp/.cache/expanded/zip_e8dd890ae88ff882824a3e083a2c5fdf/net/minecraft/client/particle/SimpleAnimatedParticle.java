...
public class SimpleAnimatedParticle extends TextureSheetParticle {
    ...
    public void setColor(int pColor) {
        float f = ((pColor & 0xFF0000) >> 16) / 255.0F;
        float f1 = ((pColor & 0xFF00) >> 8) / 255.0F;
        float f2 = ((pColor & 0xFF) >> 0) / 255.0F;
        float f3 = 1.0F;
        this.setColor(f * 1.0F, f1 * 1.0F, f2 * 1.0F);
    }

    public void setFadeColor(int pRgb) {
        this.fadeR = ((pRgb & 0xFF0000) >> 16) / 255.0F;
        this.fadeG = ((pRgb & 0xFF00) >> 8) / 255.0F;
        this.fadeB = ((pRgb & 0xFF) >> 0) / 255.0F;
        this.hasFade = true;
    }
