                ...
                ItemPredicate.Builder.item()
                    ...
                    .withComponents(
                        DataComponentMatchers.Builder.components()
                            .exact(
                                DataComponentExactPredicate.someOf(Raid.getOminousBannerInstance(pPatternRegistry).getComponents(), DataComponents.BANNER_PATTERNS, DataComponents.ITEM_NAME)
                            )
                            .build()
                    )
            )
