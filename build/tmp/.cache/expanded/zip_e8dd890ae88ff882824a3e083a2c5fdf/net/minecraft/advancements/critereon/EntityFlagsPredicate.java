    ...
    public boolean matches(Entity pEntity) {
        if (this.isOnGround.isPresent() && pEntity.onGround() != this.isOnGround.get()) {
            ...
            if (this.isFlying.isPresent()) {
                boolean flag = pEntity instanceof LivingEntity livingentity
            ...
            return !(this.isBaby.isPresent() && pEntity instanceof LivingEntity livingentity1) || livingentity1.isBaby() == this.isBaby.get();
        }
    }
