...
public class HexColorArgument implements ArgumentType<Integer> {
    ...
    public static Integer getHexColor(CommandContext<CommandSourceStack> pContext, String pArgument) {
        return pContext.getArgument(pArgument, Integer.class);
    }
    ...
    public Integer parse(StringReader pReader) throws CommandSyntaxException {
        ...
        return switch (s.length()) {
            ...
            default -> throw ERROR_INVALID_HEX.createWithContext(pReader, s);
        };
    }

    @Override
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> pContext, SuggestionsBuilder pBuilder) {
        return SharedSuggestionProvider.suggest(EXAMPLES, pBuilder);
    }
