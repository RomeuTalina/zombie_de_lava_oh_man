...
public class ComponentPredicateParser {
    public static <T, C, P> Grammar<List<T>> createGrammar(ComponentPredicateParser.Context<T, C, P> pContext) {
        ...
        dictionary.put(atom3, new ComponentPredicateParser.ElementLookupRule<>(namedrule, pContext));
        dictionary.put(atom4, new ComponentPredicateParser.TagLookupRule<>(namedrule, pContext));
        dictionary.put(
            atom5,
        ...
        dictionary.put(atom8, dictionary.named(atom9), p_331974_ -> pContext.negate(p_331974_.getOrThrow(atom9)));
            ...
            p_389645_ -> {
                ...
                try {
                    if (p != null) {
                        ...
                        return pContext.createPredicateTest(p_389645_.input(), p, dynamic1);
                    } else {
                        C c = scope.getOrThrow(atom10);
                        Dynamic<?> dynamic = scope.get(atom13);
                        return dynamic != null ? pContext.createComponentTest(p_389645_.input(), c, dynamic) : pContext.createComponentTest(p_389645_.input(), c);
                    }
        ...
        dictionary.put(atom10, new ComponentPredicateParser.ComponentLookupRule<>(namedrule, pContext));
        dictionary.put(atom11, new ComponentPredicateParser.PredicateLookupRule<>(namedrule, pContext));
    ...
    static class ComponentLookupRule<T, C, P> extends ResourceLookupRule<ComponentPredicateParser.Context<T, C, P>, C> {
        ComponentLookupRule(NamedRule<StringReader, ResourceLocation> pIdParser, ComponentPredicateParser.Context<T, C, P> pContext) {
    ...
    public interface Context<T, C, P> {
        ...
        T createComponentTest(ImmutableStringReader pReader, C pContext, Dynamic<?> pData) throws CommandSyntaxException;
        ...
        T createPredicateTest(ImmutableStringReader pReader, P pPredicateType, Dynamic<?> pData) throws CommandSyntaxException;
    ...
    static class ElementLookupRule<T, C, P> extends ResourceLookupRule<ComponentPredicateParser.Context<T, C, P>, T> {
        ElementLookupRule(NamedRule<StringReader, ResourceLocation> pIdParser, ComponentPredicateParser.Context<T, C, P> pContext) {
            super(pIdParser, pContext);
        }
    ...
    static class PredicateLookupRule<T, C, P> extends ResourceLookupRule<ComponentPredicateParser.Context<T, C, P>, P> {
        PredicateLookupRule(NamedRule<StringReader, ResourceLocation> pIdParser, ComponentPredicateParser.Context<T, C, P> pContext) {
            super(pIdParser, pContext);
        }
    ...
    static class TagLookupRule<T, C, P> extends ResourceLookupRule<ComponentPredicateParser.Context<T, C, P>, T> {
        TagLookupRule(NamedRule<StringReader, ResourceLocation> pIdParser, ComponentPredicateParser.Context<T, C, P> pContext) {
            super(pIdParser, pContext);
        }
