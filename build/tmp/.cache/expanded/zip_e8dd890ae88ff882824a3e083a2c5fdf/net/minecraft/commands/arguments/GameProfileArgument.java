...
public class GameProfileArgument implements ArgumentType<GameProfileArgument.Result> {
    ...
    public <S> GameProfileArgument.Result parse(StringReader pReader, S pSuggestionProvider) throws CommandSyntaxException {
        return parse(pReader, EntitySelectorParser.allowSelectors(pSuggestionProvider));
    }
