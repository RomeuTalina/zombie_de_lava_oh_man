...
public record Weighted<T>(T value, int weight) {
    ...
    public static <E> Codec<Weighted<E>> codec(Codec<E> pElementCodec) {
        return codec(pElementCodec.fieldOf("data"));
    }

    public static <E> Codec<Weighted<E>> codec(MapCodec<E> pElementCodec) {
        return RecordCodecBuilder.create(
            p_391586_ -> p_391586_.group(
                    pElementCodec.forGetter((Function<Weighted<E>, E>)(Weighted::value)),
    ...
    public <U> Weighted<U> map(Function<T, U> pMapper) {
        return new Weighted<>(pMapper.apply(this.value()), this.weight);
    }
}