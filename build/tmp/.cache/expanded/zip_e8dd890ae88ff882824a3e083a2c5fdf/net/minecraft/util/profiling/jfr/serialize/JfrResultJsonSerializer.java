...
public class JfrResultJsonSerializer {
    ...
    private static void serializeChunkId(ChunkIdentification pChunkIdentification, JsonObject pJson) {
        pJson.addProperty("level", pChunkIdentification.level());
        pJson.addProperty("dimension", pChunkIdentification.dimension());
        pJson.addProperty("x", pChunkIdentification.x());
        pJson.addProperty("z", pChunkIdentification.z());
    }
