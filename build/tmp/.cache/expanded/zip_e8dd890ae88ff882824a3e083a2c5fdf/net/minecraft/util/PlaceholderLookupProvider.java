...
public class PlaceholderLookupProvider implements HolderGetter.Provider {
    ...
    public PlaceholderLookupProvider(HolderLookup.Provider pContext) {
    ...
    class UniversalLookup implements HolderGetter<Object>, HolderOwner<Object> {
        ...
        private Holder.Reference<Object> getOrCreate(ResourceKey<Object> pKey) {
            return PlaceholderLookupProvider.this.holders
                .computeIfAbsent(pKey, p_393201_ -> Holder.Reference.createStandAlone(this, (ResourceKey<Object>)p_393201_));
        }
        ...
        private HolderSet.Named<Object> getOrCreate(TagKey<Object> pKey) {
            return PlaceholderLookupProvider.this.holderSets.computeIfAbsent(pKey, p_391551_ -> HolderSet.emptyNamed(this, (TagKey<Object>)p_391551_));
        }
