...
public interface ErrorCollector<S> {
    ...
    public static class LongestOnly<S> implements ErrorCollector<S> {
        ...
        private void addErrorEntry(SuggestionSupplier<S> pSuggestions, Object pReason) {
            ...
            mutableerrorentry1.suggestions = pSuggestions;
            mutableerrorentry1.reason = pReason;
        }
