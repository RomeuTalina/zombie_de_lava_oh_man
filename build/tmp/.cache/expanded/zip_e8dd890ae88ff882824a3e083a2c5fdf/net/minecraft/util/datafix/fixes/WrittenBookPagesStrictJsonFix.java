...
public class WrittenBookPagesStrictJsonFix extends ItemStackTagFix {
    public WrittenBookPagesStrictJsonFix(Schema pOutputSchema) {
        super(pOutputSchema, "WrittenBookPagesStrictJsonFix", p_406989_ -> p_406989_.equals("minecraft:written_book"));
    }
