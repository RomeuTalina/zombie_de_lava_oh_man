...
public class V1451_3 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
        ...
        pSchema.register(map, "minecraft:enderman", () -> DSL.optionalFields("carriedBlockState", References.BLOCK_STATE.in(pSchema)));
        pSchema.register(
            map,
        ...
        pSchema.register(
            ...
            () -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(pSchema), "LastOutput", References.TEXT_COMPONENT.in(pSchema))
        );
