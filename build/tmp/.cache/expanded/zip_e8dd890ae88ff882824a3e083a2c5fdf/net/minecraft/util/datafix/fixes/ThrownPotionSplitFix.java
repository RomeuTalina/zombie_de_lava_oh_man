...
public class ThrownPotionSplitFix extends EntityRenameFix {
    ...
    public ThrownPotionSplitFix(Schema pOutputSchema) {
        super("ThrownPotionSplitFix", pOutputSchema, true);
    }
    ...
    record ItemIdFinder(OpticFinder<?> itemFinder, OpticFinder<Pair<String, String>> itemIdFinder) {
        public String getItemId(Typed<?> pData) {
            return pData.getOptionalTyped(this.itemFinder)
