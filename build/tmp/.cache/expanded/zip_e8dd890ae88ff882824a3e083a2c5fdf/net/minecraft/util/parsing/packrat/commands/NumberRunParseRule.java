...
public abstract class NumberRunParseRule implements Rule<StringReader, String> {
    ...
    public NumberRunParseRule(DelayedException<CommandSyntaxException> pNoValueError, DelayedException<CommandSyntaxException> pUnderscoreNotAllowedError) {
        this.noValueError = pNoValueError;
        this.underscoreNotAllowedError = pUnderscoreNotAllowedError;
    }
