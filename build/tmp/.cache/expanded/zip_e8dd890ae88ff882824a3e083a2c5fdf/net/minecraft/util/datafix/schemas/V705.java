...
public class V705 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
        ...
        pSchema.register(
            ...
            p_390423_ -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(pSchema), "LastOutput", References.TEXT_COMPONENT.in(pSchema))
        );
        ...
        pSchema.register(
            map,
            "minecraft:donkey",
            p_390427_ -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(pSchema)), "SaddleItem", References.ITEM_STACK.in(pSchema))
        );
        ...
        pSchema.register(map, "minecraft:enderman", p_18158_ -> DSL.optionalFields("carried", References.BLOCK_NAME.in(pSchema)));
        ...
        pSchema.register(map, "minecraft:fireworks_rocket", p_390431_ -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in(pSchema)));
        ...
        pSchema.register(
            map,
            "minecraft:horse",
            p_390421_ -> DSL.optionalFields("ArmorItem", References.ITEM_STACK.in(pSchema), "SaddleItem", References.ITEM_STACK.in(pSchema))
        );
        ...
        pSchema.register(
            map,
            "minecraft:mule",
            p_390425_ -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(pSchema)), "SaddleItem", References.ITEM_STACK.in(pSchema))
        );
        ...
        pSchema.register(map, "minecraft:skeleton_horse", p_18140_ -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(pSchema)));
        ...
        pSchema.register(map, "minecraft:zombie_horse", p_390435_ -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(pSchema)));
        registerMob(pSchema, map, "minecraft:zombie_pigman");
        pSchema.register(
            map,
            "minecraft:zombie_villager",
            p_390418_ -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(pSchema))))
        );
    ...
    public void registerTypes(Schema pSchema, Map<String, Supplier<TypeTemplate>> pEntityTypes, Map<String, Supplier<TypeTemplate>> pBlockEntityTypes) {
        ...
        pSchema.registerType(
            ...
            () -> DSL.and(
                ...
                DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", namespacedString(), pEntityTypes))
            )
        );
        pSchema.registerType(
            true,
            References.ITEM_STACK,
            () -> DSL.hook(DSL.optionalFields("id", References.ITEM_NAME.in(pSchema), "tag", V99.itemStackTag(pSchema)), ADD_NAMES, HookFunction.IDENTITY)
        );
    }
}