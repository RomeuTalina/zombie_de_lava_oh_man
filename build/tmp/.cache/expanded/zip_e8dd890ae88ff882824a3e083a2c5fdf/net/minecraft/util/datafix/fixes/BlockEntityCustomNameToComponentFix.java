...
public class BlockEntityCustomNameToComponentFix extends DataFix {
    ...
    public BlockEntityCustomNameToComponentFix(Schema pOutputSchema) {
    ...
    public static <T> Dynamic<T> fixTagCustomName(Dynamic<T> pTag) {
        String s = pTag.get("CustomName").asString("");
        return s.isEmpty() ? pTag.remove("CustomName") : pTag.set("CustomName", LegacyComponentDataFixUtils.createPlainTextComponent(pTag.getOps(), s));
    }
}