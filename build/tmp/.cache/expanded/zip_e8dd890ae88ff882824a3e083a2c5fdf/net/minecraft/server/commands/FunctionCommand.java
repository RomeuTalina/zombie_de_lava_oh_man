...
public class FunctionCommand {
    ...
    private static <T extends ExecutionCommandSource<T>> void queueFunctionsAsReturn(
        ...
        CommandResultCallback commandresultcallback = CommandResultCallback.chain(pOriginalSource.callback(), pExecutionControl.currentFrame().returnValueConsumer());
        ...
        for (CommandFunction<T> commandfunction : pFunctions) {
            ...
            instantiateAndQueueFunctions(pArguments, pExecutionControl, commanddispatcher, t, commandfunction, resourcelocation, commandresultcallback1, true);
        }

        pExecutionControl.queueNext(FallthroughTask.instance());
    }
