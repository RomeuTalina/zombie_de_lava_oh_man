...
public class PathPackResources extends AbstractPackResources {
    ...
    private static boolean isRegularFile(Path pPath, BasicFileAttributes pAttributes) {
        return !SharedConstants.IS_RUNNING_IN_IDE
            ? pAttributes.isRegularFile()
            : pAttributes.isRegularFile() && !StringUtils.equalsIgnoreCase(pPath.getFileName().toString(), ".ds_store");
    }
