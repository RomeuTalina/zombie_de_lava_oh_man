...
public class ServerRecipeBook extends RecipeBook {
    ...
    public void sendInitialRecipeBook(ServerPlayer pPlayer) {
        pPlayer.connection.send(new ClientboundRecipeBookSettingsPacket(this.getBookSettings().copy()));
    ...
    private void apply(ServerRecipeBook.Packed pRecipeBook) {
        this.known.clear();
        this.highlight.clear();
        this.bookSettings.replaceFrom(pRecipeBook.settings);
        this.known.addAll(pRecipeBook.known);
        this.highlight.addAll(pRecipeBook.highlight);
    }

    public void loadUntrusted(ServerRecipeBook.Packed pRecipeBook, Predicate<ResourceKey<Recipe<?>>> pPredicate) {
        this.bookSettings.replaceFrom(pRecipeBook.settings);
        this.loadRecipes(pRecipeBook.known, this.known::add, pPredicate);
        this.loadRecipes(pRecipeBook.highlight, this.highlight::add, pPredicate);
    }
